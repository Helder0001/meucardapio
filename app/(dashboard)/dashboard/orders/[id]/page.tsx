    ...
    include: {
      ...
      payments: {
        ...
        select: {
          ...
          changeAmount: true, createdAt: true, pixExpiresAt: true, setAtOrderCreation: true,
          checkoutUrl: true, provider: true, providerReference: true, pixEndToEndId: true,
        },
      },
      statusHistory: {
        ...
        select: {
          ...
          ...(true && { user: { select: { name: true, role: true } } } as any),
        },
      },
    },
  })
