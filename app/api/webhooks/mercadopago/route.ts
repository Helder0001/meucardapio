...
export async function POST(request: Request) {
  try {
    ...
    // Roteamento por tipo de evento — só pagamentos de pedido dos tenants.
    // A cobrança recorrente do plano PRO da própria plataforma foi migrada
    // pra Efí Bank (ver app/api/webhooks/efi/route.ts); não existe mais
    // nenhum assinante ativo no Mercado Pago, então os handlers de
    // subscription_preapproval/subscription_authorized_payment/pagamento-
    // de-assinatura foram removidos daqui.
