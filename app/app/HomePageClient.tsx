...
const features = [
  { icon: '📱', title: 'Cardápio Digital', desc: 'PWA instalável com QR Code por mesa. Atualize preços em tempo real, sem reimprimir nada.', color: 'from-brand-500 to-amber-400', bg: 'bg-brand-50 dark:bg-brand-950/20' },
      ...
      <nav className="sticky top-0 z-50 bg-white/80 dark:bg-gray-950/80 backdrop-blur-xl border-b border-gray-100 dark:border-gray-800">
        <div className="max-w-6xl mx-auto px-5 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 bg-gradient-to-br from-brand-500 to-amber-400 rounded-xl flex items-center justify-center shadow-sm">
              <span className="text-white font-black text-sm">F</span>
            </div>
            <span className="font-black text-gray-900 dark:text-white text-lg tracking-tight">
              Food<span className="text-brand-500">SaaS</span>
            </span>
          </div>
      ...
      <section id="planos" className="py-24 bg-gray-50/60 dark:bg-gray-900/30">
        <div className="max-w-5xl mx-auto px-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {plans.map((plan) => (
              <div key={plan.name} className={`relative rounded-3xl p-7 flex flex-col transition-all ${plan.highlight ? 'bg-gradient-to-b from-brand-500 to-brand-600 text-white shadow-2xl shadow-brand-200 dark:shadow-brand-900/40 scale-[1.03]' : 'bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 card-hover'}`}>
                {plan.highlight && (
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-10">
            <div className="max-w-xs">
              <div className="flex items-center gap-2.5 mb-4">
                <div className="w-8 h-8 bg-gradient-to-br from-brand-500 to-amber-400 rounded-xl flex items-center justify-center">
                  <span className="text-white font-black text-sm">F</span>
                </div>
                <span className="font-black text-gray-900 dark:text-white text-lg tracking-tight">Food<span className="text-brand-500">SaaS</span></span>
              </div>
